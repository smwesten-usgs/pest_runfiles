...
replacements['~max_net_infil_mult_ab~'] = np.random.uniform(low=0.25, high=0.5)
replacements['~max_net_infil_mult_ac~'] = np.random.uniform(low=0.1, high=0.25)
replacements['~max_net_infil_mult_ad~'] = np.random.uniform(low=0.01, high=0.1)

# pretend values for the rooting_zone multipliers
replacements['~rooting_depth_mult_ab~'] = np.random.uniform(low=0.8, high=1.2)
replacements['~rooting_depth_mult_ac~'] = np.random.uniform(low=0.75, high=1.05)
replacements['~rooting_depth_mult_ad~'] = np.random.uniform(low=0.7, high=0.95)
