...
max_net_infil_mult_ab = ~max_net_infil_ab~
max_net_infil_mult_ac = ~max_net_infil_ac~
max_net_infil_mult_ad = ~max_net_infil_ad~

[rooting_depth_multipliers]
rooting_depth_mult_ab = ~rooting_depth_ab~
rooting_depth_mult_ac = ~rooting_depth_ac~
rooting_depth_mult_ad = ~rooting_depth_ad~